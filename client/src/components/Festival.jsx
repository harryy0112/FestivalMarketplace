  ...
  onCreateFestival = async (e) => {
    try {
      ...
      const {
        events: {
          Created: {
            returnValues: { ntfAddress, marketplaceAddress },
          },
        },
      ...
      if (supply < 30) {
        const res = await nftInstance.methods
          .bulkMintTickets(supply, marketplaceAddress)
          .send({ from: organiser, gas: 6700000 });
      } else {
        for (let i = 0; i < batches; i++) {
          ...
          const res = await nftInstance.methods
            .bulkMintTickets(batchSupply, marketplaceAddress)
            .send({ from: organiser, gas: 6700000 });
        }
      }
    } catch (err) {
          ...
          <div class="container ">
            <div class="container ">
              ...
              <form class="" onSubmit={this.onCreateFestival}>
                <label class="left">Fest Name</label>
                <input
                  id="name"
                  class="validate"
                ...
                <br />
                <br />
                <label class="left">Fest Symbol</label>
                <input
                  id="symbol"
                  class="validate"
                ...
                <br />
                <br />
                <label class="left">Ticket Price</label>
                <input
                  id="price"
                ...
                <br />
                <br />
                <label class="left">Total Supply</label>
                <input
                  id="supply"
